    ...
    <div class="container">
        <div class="grid-2" style="gap: 2rem; align-items: start;">
            <article style="background: #f7fbff; border: 1.5px solid #e4eef8; border-radius: 20px; padding: 2rem;">
                ...
                <h3 style="color: #0d1f3c; margin-bottom: 0.75rem;">Company Overview</h3>
                <p style="color: #546e8a; font-size: 0.95rem; line-height: 1.75;">GUF Agency Ltd is a fully incorporated entity licensed and regulated by the Insurance Regulatory Authority of Uganda (IRA). Incorporated in 2023 and duly registered under the Companies Act with certification from the Uganda Registration Service Bureau (URSB).</p>
                <p style="color: #546e8a; font-size: 0.95rem; line-height: 1.75; margin-bottom: 0;">Our formal registration underscores our dedication to the highest standards of professionalism, integrity, transparency, and accountability.</p>
            </article>
            <article style="background: #f7fbff; border: 1.5px solid #e4eef8; border-radius: 20px; padding: 2rem;">
                <div class="icon-box"><i class="fa-solid fa-scale-balanced"></i></div>
                <h3 style="color: #0d1f3c; margin-bottom: 0.75rem;">Independent Advisory Role</h3>
                <p style="color: #546e8a; font-size: 0.95rem; line-height: 1.75;">As independent insurance agents, we work closely with each client to understand their unique risks and objectives. We provide unbiased advice on the best insurance companies and products to meet their specific needs.</p>
                <p style="color: #546e8a; font-size: 0.95rem; line-height: 1.75; margin-bottom: 0;">Our extensive network of top-tier insurance providers and in-depth industry knowledge enable us to negotiate competitive rates and terms for optimal coverage and value.</p>
            </article>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="grid-2" style="gap: 4rem; align-items: center;">
            <div>
                ...
                <h2 style="font-size: 2.1rem; color: #0d1f3c; margin-bottom: 0.5rem;">Client-First, Always</h2>
                <div class="divider"></div>
                <p style="color: #546e8a; font-size: 0.95rem; line-height: 1.75; margin-bottom: 0.5rem;">Our integrated approach delivers holistic solutions that protect our clients' interests. Our experienced team provides personalised service and expert advice for:</p>
            ...
            <div class="grid-2" style="gap: 1rem;">
                @php
                    $badges = [
                        ['certificate', 'IRA Licensed', 'Insurance Regulatory Authority'],
                        ['building', 'URSB Certified', 'Uganda Registration Service Bureau'],
                        ['handshake', 'Independent', 'Unbiased advisory always'],
                        ['calendar-check', 'Since 2023', 'Active in the Ugandan market'],
                    ];
                @endphp
                @foreach($badges as $b)
                    <div style="background: #fff; border: 1.5px solid #e4eef8; border-radius: 16px; padding: 1.5rem 1rem; text-align: center;">
                        <div style="font-size: 1.75rem; margin-bottom: 0.5rem; color: var(--brand);"><i class="fa-solid fa-{{ $b[0] }}"></i></div>
                        <div style="font-weight: 700; color: #0d1f3c; font-size: 0.95rem;">{{ $b[1] }}</div>
                        <div style="font-size: 0.78rem; color: #788fa8; margin-top: 2px;">{{ $b[2] }}</div>
                    </div>
                @endforeach
            </div>
        </div>
